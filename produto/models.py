...
class Produto(models.Model):
    ...
    preco_mkt = models.FloatField(verbose_name='Preço')
    preco_mkt_promo = models.FloatField(default=0, verbose_name='Preço Promo')
    ...
    def get_preco_promo_formatado(self):
        return utils.formata_preco(self.preco_mkt_promo)
